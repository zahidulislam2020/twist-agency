(function ( $ ) {
    ...
    var methods = {
        init : function(options) {
            ...
            // Create percentage
            var percentage_b = $("<div class='progress-percentage_b progress-percentage'></div>");
            
            if(!global_settings.percentage_b) {
                percentage_b.text(global_settings.percentage_b);
            }
            $(this).append(percentage_b);
    ...
    $.fn.circularProgress_b = function(methodOrOptions) {
    ...
    function insertText(scope) {
        $(".progress-percentage_b").text(Math.round(global_settings.percent) + "%");
    }
    // create canvas
