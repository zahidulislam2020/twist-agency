(function ( $ ) {
    ...
    var methods = {
        init : function(options) {
            ...
            // Create percentage
            var percentage_c = $("<div class='progress-percentage_c progress-percentage'></div>");
            
            if(!global_settings.percentage_c) {
                percentage_c.text(global_settings.percentage_c);
            }
            $(this).append(percentage_c);
    ...
    $.fn.circularProgress_c = function(methodOrOptions) {
    ...
    function insertText(scope) {
        $(".progress-percentage_c").text(Math.round(global_settings.percent) + "%");
    }
    // create canvas
