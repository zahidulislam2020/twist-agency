(function ( $ ) {
        ...
        var methods = {
            init : function(options) {
                ...
                // Create percentage
                var percentage_a = $("<div class='progress-percentage_a progress-percentage'></div>");
                
                if(!global_settings.percentage_a) {
                    percentage_a.text(global_settings.percentage_a);
                }
                $(this).append(percentage_a);
        ...
        $.fn.circularProgress_a = function(methodOrOptions) {
        ...
        function insertText(scope) {
            $(".progress-percentage_a").text(Math.round(global_settings.percent) + "%");
        }
        // create canvas
